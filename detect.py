...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
        source=ROOT / 'hrsc_data/hrsc/test_data/images',  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='./hrsc_data/hrsc/test_data/images/', help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--save-txt', type=str, default='True', help='save results to *.txt')
    parser.add_argument('--save-conf', type=str, default='True', help='save confidences in --save-txt labels')
